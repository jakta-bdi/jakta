 ...
 */
@JaktaDSL
interface MasBuilder<Belief : Any, Goal : Any, Env : Node> {
...
//    fun withAgents(vararg agents: Agent<Belief, Goal>)
     ...
     */
    fun build(): NodeRunner<Belief, Goal, Env>
}

/**
 * Implementation of the MasBuilder interface.
 */
open class MasBuilderImpl<Belief : Any, Goal : Any, Env : Node> : MasBuilder<Belief, Goal, Env> {
...
//    }
    ...
    override fun build(): NodeRunner<Belief, Goal, Env> {
