...
class TestPlans :
    DescribeSpec({
        ...
        data class VerifySubstitution(val term: Term, val expected: Int) : AbstractAction.WithoutSideEffects() {
        ...
        describe("A Plan") {
            ...
            it("should be applicable if its trigger is a valid Predicate") {
                ...
                val bb = MutableBeliefBase.of(listOf(chocolateNeed))
            ...
            it("should unify the triggering event variables") {
                ...
                p.isApplicable(event, MutableBeliefBase.of()) shouldBe true
                val ap = p.applicablePlan(event, MutableBeliefBase.of())
