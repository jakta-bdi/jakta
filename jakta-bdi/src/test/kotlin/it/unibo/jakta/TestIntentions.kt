    ...
    DescribeSpec({
        ...
        describe("An intention") {
            ...
            it("should apply a substitution on the actual Activation Record") {
                ...
                data class VerifySubstitution(var value: Term) : AbstractAction.WithoutSideEffects() {
                ...
                substitutedIntention.stack
                    .last()
                    .nextActionToExecute()
                    .shouldBeInstanceOf<VerifySubstitution>()
