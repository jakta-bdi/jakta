...
interface Belief {
    ...
    companion object {
        ...
        fun fromSelfSource(
            head: Struct,
            vararg body: Term,
        ): Belief = fromSelfSource(head, body.asIterable())
        ...
        fun fromSelfSource(
            head: Struct,
            body: Iterable<Term>,
        ): Belief = of(head, body, false)

        fun fromPerceptSource(
            head: Struct,
            vararg body: Term,
        ): Belief = fromPerceptSource(head, body.asIterable())
        ...
        fun fromPerceptSource(
            head: Struct,
            body: Iterable<Term>,
        ): Belief = of(head, body, true)

        fun fromMessageSource(
            from: String,
            head: Struct,
            vararg body: Term,
        ): Belief = fromMessageSource(from, head, body.asIterable())
