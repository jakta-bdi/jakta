 ...
 */
@JaktaDSL
sealed interface PlanBuilder<B : Any, G : Any, Context : Any> {

    /**
     * Builder interface for defining plans triggered by additions of beliefs or goals.
     */
    sealed interface Addition<B : Any, G : Any, Context : Any> : PlanBuilder<B, G, Context> {
        ...
        interface Belief<B : Any, G : Any, Context : Any> : Addition<B, G, Context> {
            ...
            fun <PlanResult> triggersImpl(
                resultType: KType,
                body: suspend PlanScope<B, G, Context>.() -> PlanResult,
     ...
     */
    sealed interface Removal<B : Any, G : Any, Context : Any> : PlanBuilder<B, G, Context> {
     ...
     */
    sealed interface FailureInterception<B : Any, G : Any, Context : Any> : PlanBuilder<B, G, Context> {
...
inline infix fun <B, G, Ctx, reified PlanResult> PlanBuilder.Addition.Belief<B, G, Ctx>.triggers(
    noinline body: suspend PlanScope<B, G, Ctx>.() -> PlanResult,
 ...
 */
@Suppress("DEPRECATION_ERROR")
inline infix fun <B, G, Context, reified PlanResult> PlanBuilder.Addition.Goal<B, G, Context>.triggers(
    noinline body: suspend PlanScope<B, G, Context>.() -> PlanResult,
): Plan.Goal.Addition<B, G, Context, PlanResult> where B : Any, G : Any, Context : Any =
    this.triggersImpl(typeOf<PlanResult>(), body)
 ...
 */
@Suppress("DEPRECATION_ERROR")
inline infix fun <B, G, Context, reified PlanResult> PlanBuilder.Removal.Belief<B, G, Context>.triggers(
    noinline body: suspend PlanScope<B, G, Context>.() -> PlanResult,
): Plan.Belief.Removal<B, G, Context, PlanResult> where B : Any, G : Any, Context : Any =
    this.triggersImpl(typeOf<PlanResult>(), body)
 ...
 */
@Suppress("DEPRECATION_ERROR")
inline infix fun <B, G, Context, reified PlanResult> PlanBuilder.Removal.Goal<B, G, Context>.triggers(
    noinline body: suspend PlanScope<B, G, Context>.() -> PlanResult,
): Plan.Goal.Removal<B, G, Context, PlanResult> where B : Any, G : Any, Context : Any =
    this.triggersImpl(typeOf<PlanResult>(), body)
